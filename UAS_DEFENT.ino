...
String Web_App_URL = "https://script.google.com/macros/";
...
void http_Req(String str_modes, String str_uid, String mode_type) {
  if (WiFi.status() == WL_CONNECTED) {
    ...
    // ==========================================
    // PERTAHANAN 1: TOKEN RAHASIA
    // ==========================================
    // Token ini harus SAMA PERSIS dengan yang ada di Google Apps Script
    String SECRET_TOKEN = "7uywbbh9"; 
    // ==========================================
    ...
    if (str_modes == "atc") {
      ...
      http_req_url += "&token=" + SECRET_TOKEN;
    }
    ...
    if (httpCode > 0) {
      ...
      // Cek jika Token Salah (Akses Ditolak)
      if (payload.indexOf("Akses Ditolak") != -1) {
        lcd.clear();
        lcd.setCursor(0, 0);
